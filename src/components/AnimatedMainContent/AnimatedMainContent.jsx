...
import { animated, useTransition, config, Trail } from "react-spring";
...
const AnimatedMainContent = (props) => {
  ...
  const homePinTransition2 = useTransition(props.index, {
    from: { opacity: 0, transform: "translate3d(0, 0px, 0)", zIndex: 0 },
    enter: { opacity: 1, transform: "translate3d(0, -60px, 0)", zIndex: 2, delay: 500 },
    leave: {
      opacity: 0,
      transform: "translate3d(0, -80px, 0)",
      delay: 1500,
  ...
  const homePinTransition3 = useTransition(props.index, {
    from: { opacity: 0, transform: "translate3d(0, 0px, 0)", zIndex: 0 },
    enter: { opacity: 1, transform: "translate3d(0, -60px, 0)", zIndex: 2, delay: 600 },
    leave: {
      opacity: 0,
      transform: "translate3d(0, -80px, 0)",
      delay: 2000,
  ...
  const homePinTransition4 = useTransition(props.index, {
    from: { opacity: 0, transform: "translate3d(0, 0px, 0)", zIndex: 0 },
    enter: { opacity: 1, transform: "translate3d(0, -60px, 0)", zIndex: 2, delay: 700 },
    leave: {
      opacity: 0,
      transform: "translate3d(0, -80px, 0)",
      delay: 2500,
  ...
  const homePinTransition5 = useTransition(props.index, {
    from: { opacity: 0, transform: "translate3d(0, 0px, 0)", zIndex: 0 },
    enter: { opacity: 1, transform: "translate3d(0, -60px, 0)", zIndex: 2, delay: 800 },
    leave: {
      opacity: 0,
      transform: "translate3d(0, -80px, 0)",
      delay: 3000,
  ...
  const homePinTransition6 = useTransition(props.index, {
    from: { opacity: 0, transform: "translate3d(0, 0px, 0)", zIndex: 0 },
    enter: { opacity: 1, transform: "translate3d(0, -60px, 0)", zIndex: 2, delay: 900 },
    leave: {
      opacity: 0,
      transform: "translate3d(0, -80px, 0)",
      delay: 3500,
